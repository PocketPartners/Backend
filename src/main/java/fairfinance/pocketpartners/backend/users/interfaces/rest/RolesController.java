...
import fairfinance.pocketpartners.backend.users.domain.services.RoleQueryService;
import fairfinance.pocketpartners.backend.users.interfaces.rest.resources.RoleResource;
import fairfinance.pocketpartners.backend.users.interfaces.rest.transform.RoleResourceFromEntityAssembler;
